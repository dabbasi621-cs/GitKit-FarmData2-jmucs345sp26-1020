...
export declare const PREFERENCE_NAME_THINKING_MODE = "ai-features.thinkingMode.defaults";
...
export declare const PREFERENCE_NAME_SKILL_DIRECTORIES = "ai-features.skills.skillDirectories";
