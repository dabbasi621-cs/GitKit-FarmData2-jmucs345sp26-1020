...
export declare const PLUGIN_SCM_TITLE_MENU: MenuPath;
...
export declare const codeToTheiaMappings: Map<string, MenuPath[]>;
type CodeEditorWidget = EditorWidget | WebviewWidget;
export declare namespace CodeEditorWidgetUtil {
    function is(arg: unknown): arg is CodeEditorWidget;
