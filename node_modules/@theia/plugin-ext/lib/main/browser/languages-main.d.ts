import { LanguagesMain, SerializedLanguageConfiguration, WorkspaceEditDto, PluginInfo, LanguageStatus as LanguageStatusDTO, HoverWithId } from '../../common/plugin-api-rpc';
...
export declare class LanguagesMainImpl implements LanguagesMain, Disposable {
    ...
    protected provideHover(handle: number, model: monaco.editor.ITextModel, position: monaco.Position, token: monaco.CancellationToken, context?: monaco.languages.HoverContext<HoverWithId>): monaco.languages.ProviderResult<monaco.languages.Hover>;
    ...
    protected createDocumentRangeSemanticTokensProvider(handle: number, legend: theia.SemanticTokensLegend, event?: Event<void>): monaco.languages.DocumentRangeSemanticTokensProvider;
