...
export declare function fromHover(hover: theia.VerboseHover): model.Hover;
...
export declare namespace SymbolKind {
    ...
    function fromLspSymbolKind(kind: lstypes.SymbolKind): theia.SymbolKind;
    function toLspSymbolKind(kind: model.SymbolKind): lstypes.SymbolKind;
}
