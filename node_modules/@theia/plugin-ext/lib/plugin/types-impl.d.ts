...
export declare class VerboseHover extends Hover {
    ...
    constructor(contents: theia.MarkdownString | theia.MarkedString | (theia.MarkdownString | theia.MarkedString)[], range?: Range, canIncreaseVerbosity?: boolean, canDecreaseVerbosity?: boolean);
}
