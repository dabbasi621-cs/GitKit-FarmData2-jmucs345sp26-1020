import { LanguagesExt, Position, Selection, RawColorInfo, WorkspaceEditDto, PluginInfo, Plugin, InlayHintsDto, InlayHintDto, IdentifiableInlineCompletions, HoverWithId } from '../common/plugin-api-rpc';
...
export declare class LanguagesExtImpl implements LanguagesExt {
    ...
    $provideHover(handle: number, resource: UriComponents, position: Position, context: HoverContext<{
        id: number;
    }> | undefined, token: theia.CancellationToken): Promise<HoverWithId | undefined>;
