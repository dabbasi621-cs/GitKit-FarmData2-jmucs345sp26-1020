...
export declare class ScmExtImpl implements ScmExt {
    ...
    createSourceControl(extension: Plugin, id: string, label: string, rootUri: theia.Uri | undefined, iconPath?: theia.IconPath, parent?: theia.SourceControl): theia.SourceControl;
    private findSourceControlImpl;
