import { CommandContribution, Command, CommandRegistry, DisposableCollection, MenuContribution, MenuModelRegistry, SelectionService, Emitter, Event, PreferenceService } from '@theia/core/lib/common';
import { ApplicationShell, KeybindingContribution, WidgetManager, KeybindingRegistry, LabelProvider, WidgetOpenerOptions, StorageService, QuickInputService, FrontendApplicationContribution, OnWillStopAction, FrontendApplication, Widget } from '@theia/core/lib/browser';
...
export declare namespace TerminalMenus {
    ...
    const TERMINAL_CONTRIBUTIONS: string[];
    const TERMINAL_TITLE_CONTRIBUTIONS: string[];
}
export declare namespace TerminalCommands {
    const TERMINAL_CATEGORY = "Terminal";
    const TERMINAL_CATEGORY_KEY: string;
    const NEW: Command;
