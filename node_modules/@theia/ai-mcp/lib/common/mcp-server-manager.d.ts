...
export declare const MCPFrontendService: unique symbol;
...
export declare const MCPFrontendNotificationService: unique symbol;
...
export declare function isLocalMCPServerDescription(description: MCPServerDescription): description is LocalMCPServerDescription;
export declare function isRemoteMCPServerDescription(description: MCPServerDescription): description is RemoteMCPServerDescription;
